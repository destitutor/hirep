...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleBadRequest(ApiException exception) {
        log.info("Bad request: {}", exception.toString());
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(new ApiErrorResponse(exception));
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleNotFound(ApiException exception) {
