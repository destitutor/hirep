...
$(document).ready(function(){
  ...
  /* global ClipboardJS */
	...
	$('.kakao-login').click(function(e) {
		e.preventDefault();
		// redirect
		window.location.href = "http://localhost:8080/accounts/login/oauth2/authorize/kakao";
	});

	$('.naver-login').click(function(e) {
		e.preventDefault();
		// redirect
		window.location.href = "http://localhost:8080/accounts/login/oauth2/authorize/naver";
	});
